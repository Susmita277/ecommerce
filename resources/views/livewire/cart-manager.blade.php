            ...
            <div class="flex justify-between items-center">
                ...
                @if (count($cart) > 0)
                    <div class="flex gap-2 items-center cursor-pointer" wire:click="clearCart">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                             stroke="#f44336" class="cursor-pointer w-5 h-5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex justify-center items-center pt-24">
                    <div>
                        ...
                        <a href="{{ route('products') }}" class="flex justify-center">
                            <div class="flex justify-center gap-2 py-2 px-4 my-4 rounded-full border border-primary text-primary font-semibold">
                            ...
                            <div class="col-span-3">
                                <div class="flex gap-4">
                                    ...
                                    <div>
                                        ...
                                        <!-- Quantity Controls -->
                                        <div class="border border-gray-200 rounded-md p-1 grid grid-cols-3 gap-1 mt-4 w-[100px]">
                                            <!-- Decrease Button -->
                                            ...
                                            <!-- Increase Button (always enabled unless stock is 0) -->
                                    ...
                                    <!-- “Out of Stock” Badge appears only if user just tried to exceed stock -->
                                </div>
                                
                                        @if ($outOfStockIndex === $index)
                                        <span class="bg-red-500 text-white text-xs px-2 py-1 rounded ml-4">
                                            Out of Stock
                                        </span>
                                    @endif
                            </div>

                            <!-- Remove Icon & Per‐Item Price -->
                            <div class="grid justify-items-end col-span-1">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                     viewBox="0 0 24 24" stroke="#f44336"
