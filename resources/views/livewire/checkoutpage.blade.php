        ...
        <div class="col-span-2  p-5 sticky top-0 h-fit">
            ...
            <div class="py-3">
                ...
                <div class="flex gap-3 ">
                    <div
                        class="rounded-xl p-5 justify-center flex items-center gap-2 shadow-sm w-[150px] h-[100px] border-[var(--color-primary)] hover:border-2 transition-all smooth">
                        <div class="w-[80px] h-[80px]"><img src="https://csadmin.nmc.coop.np/cash.png"
                                class="w-full h-full object-contain"></div>
                        <h5>Cash</h5>
                    </div>

                    <div
                        class="rounded-xl p-5 justify-center flex items-center gap-2 shadow-sm [150px] h-[100px]  border-[var(--color-primary)] hover:border-2 transition-all smooth">
                        <div class="w-[80px] h-[80px]"><img src="https://csadmin.nmc.coop.np/fonepay.png"
                                class="w-full h-full object-contain"></div>
                        <h5>Fonepay</h5>
                    </div>
                </div>
        ...
        <div class="shadow-sm rounded-xl p-5 w-[450px]  ">
            <div class=" pb-2">
                <div class="border-b pb-2 grid grid-cols-5 w-full border-gray-200 gap-4 items-center">
                    ...
                    <div class=" border-b pb-2 my-2 grid grid-cols-5 w-full gap-4 items-center border-gray-100" wire:key='{{$item['product_id'] }}'>
                        <!-- Item Row -->
            ...
            <div class="btn flex gap-2 my-4 w-[150px]">
            ...
            <div class="mbtn flex gap-2 justify-center my-2">
